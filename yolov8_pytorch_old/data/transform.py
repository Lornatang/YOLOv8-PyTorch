...
from yolov8_pytorch.data.augment import CenterCrop
from yolov8_pytorch_old.utils import colorstr
from yolov8_pytorch_old.utils.instance import Instances
from yolov8_pytorch_old.utils.metrics import bbox_ioa
from yolov8_pytorch_old.utils.ops import segment2box, polygons2masks_overlap, polygons2masks
...
def classify_transforms(size=224, rect=False, mean=(0.0, 0.0, 0.0), std=(1.0, 1.0, 1.0)):  # IMAGENET_MEAN, IMAGENET_STD
    ...
    transform_list = [ClassifyLetterBox(size, auto=True) if rect else CenterCrop(size), ToTensor()]
