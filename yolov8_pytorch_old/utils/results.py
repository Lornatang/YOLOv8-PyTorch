...
from yolov8_pytorch_old.utils.visualizer import colors, save_one_box, Annotator
from yolov8_pytorch_old.data.transform import LetterBox
from yolov8_pytorch_old.utils import BaseClass
from yolov8_pytorch_old.utils.misc import inference_mode

from yolov8_pytorch_old.utils.ops import clip_boxes, masks2segments, scale_coords, xyxy2xywh

logger = logging.getLogger(__name__)


class BaseTensor(BaseClass):
...
class Keypoints(BaseTensor):
    ...
    @inference_mode()  # avoid keypoints < conf in-place error
