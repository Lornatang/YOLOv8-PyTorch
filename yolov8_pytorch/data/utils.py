...
from yolov8_pytorch.utils.ops import segments2boxes
...
class HUBDatasetStats:
    ...
    Example:
        ...
        ```python
        from yolov8_pytorch.data.utils import HUBDatasetStats
    ...
    def get_json(self, save=False, verbose=False):
        ...
        for split in 'train', 'val', 'test':
            ...
            if self.task == 'classify':
                ...
                from yolov8_pytorch.data import YOLODataset
    ...
    def process_images(self):
        ...
        from yolov8_pytorch.data import YOLODataset  # ClassificationDataset
...
def compress_one_image(f, f_new=None, max_dim=1920, quality=50):
    ...
    Example:
        ```python
        from pathlib import Path
        from yolov8_pytorch.data.utils import compress_one_image
...
def autosplit(path=DATASETS_DIR / 'coco8/images', weights=(0.9, 0.1, 0.0), annotated_only=False):
    ...
    Example:
        ```python
        from yolov8_pytorch.data.utils import autosplit
