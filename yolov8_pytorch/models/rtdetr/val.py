...
from yolov8_pytorch.data.augment import Compose, Format, v8_transforms
from yolov8_pytorch.models.yolo.detect import DetectionValidator
from yolov8_pytorch.utils import colorstr, ops
...
class RTDETRValidator(DetectionValidator):
    ...
    Example:
        ```python
        from yolov8_pytorch.models.rtdetr import RTDETRValidator
