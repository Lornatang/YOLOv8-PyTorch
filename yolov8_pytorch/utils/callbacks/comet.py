...
from yolov8_pytorch.utils import LOGGER, RANK, SETTINGS, TESTS_RUNNING, ops
...
def _create_experiment(args):
    ...
    try:
        ...
        experiment.log_other('Created from', 'yolov8_pytorch_old')
...
def on_fit_epoch_end(trainer):
    ...
    if curr_epoch == 1:
        from yolov8_pytorch.utils.torch_utils import model_info_for_loggers
