...
Usage:
    from yolov8_pytorch.utils.benchmarks import ProfileModels, benchmark
...
from yolov8_pytorch.utils.checks import check_requirements, check_yolo
from yolov8_pytorch.utils.files import file_size
